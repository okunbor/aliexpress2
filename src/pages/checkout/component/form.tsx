...
const Form = ({onAddressForm}) =>{

    return(
        <div className="col-span-8 border border-gray-200 p-4 rounded text-center">
        ...
        <button type="button"  onClick={onAddressForm} className="text-gray-900 bg-gray-500 hover:bg-gray-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> Cancel</button>
        <button  type="submit" onClick={onAddressForm} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>

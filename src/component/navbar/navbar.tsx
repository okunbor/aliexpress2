      ...
      <BrowserView>
        <nav className="bg-gray-950 flex justify-evenly pt-4">
          <div className="container flex justify-evenly w-full">
            <div className="relative group hidden md:flex px-8 pt-0 pb-8 mt-4 h-4 bg-gray-400   cursor-pointer rounded-t-lg hover:bg-gray-100 hover:text-black">
             
              <span className=" hover:text-black  ml-2  mt-1">
                <AiOutlineBars />
              </span>
              ...
              <div className="absolute left-0 top-full w-full bg-white shadow-md py-3 rounded-b-lg divide-y divide-gray-300 divide-dashed transition duration-300 invisible group-hover:visible">
                <div className="flex">
                  {/* Category List */}
                  <div>
                  <div className="w-full bg-white p-4 rounded shadow-lg">
                    {categories.map((category) => (
                      <div
                        ...
                        className="p-2 opacity-0 group-hover:opacity-100   cursor-pointer  "
                      >
                        {category.name}
                      </div>
                    ))}
